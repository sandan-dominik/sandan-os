...
// Convert Google Drive share link to direct video link
                ...
                <div className="space-y-6 mx-auto p-6 container">
                    <div className="flex justify-between items-center mb-8">
                        <Button variant="ghost" asChild className="gap-2">
                            <a href="/creative-os/b-roll-analyzer/projects">
                                ...
                                {hasActiveFilters() && (
                                    <div className="pt-4 border-t">
                                        <div className="flex flex-wrap gap-2">
                                            ...
                                            {dateRange.from && (
                                                <Badge variant="secondary" className="cursor-pointer" onClick={() => setDateRange({})}>
                                                    Date Range ×
                                                </Badge>
                                            )}
                                        </div>
